...
in `examples/v2_rd_org_month_auto_capacity_check.json`, a function-estimate example lives in
`examples/v2_function_estimates_capacity_check.json`, and a dependency-pressure planning example
